        ...
        <div class="container px-0 px-8 mx-auto sm:px-12 xl:px-5">
            ...
            <div class="w-full px-6 py-6 mx-auto mt-10 bg-white rounded-lg sm:px-8 md:px-12 sm:py-8 lg:w-5/6 xl:w-2/3">
                <div class="mt-8 prose prose-slate mx-auto lg:prose-lg">
                    ...
                    <ul>
                        <li>
                            <x-link link="https://code.visualstudio.com/">Visual Studio Code</x-link> - customized using <x-link link="https://makevscodeawesome.com/">Make VS Code Awesome</x-link> by <x-link link="https://calebporzio.com/">Caleb Porzio</x-link> - is my preferred code editor with <x-link link="https://marketplace.visualstudio.com/items?itemName=Hyzeta.vscode-theme-github-light">Github Light Theme</x-link> and <x-link link="https://github.com/tonsky/FiraCode">Fira Code</x-link> font
                        </li>
                        <li>
            ...
            <div class="w-full px-6 py-6 mx-auto bg-white rounded-lg sm:px-8 md:px-12 sm:py-8 lg:w-5/6 xl:w-2/3">
                <div class="mt-8 prose prose-slate mx-auto lg:prose-lg">
                    <h3>Productivity</h3>
                    <ul>
                        <li>
                            <x-link link="https://trello.com/en">Trello</x-link> for Task Management
                        </li>
                        <li>
            ...
            <div class="w-full px-6 py-6 mx-auto bg-white rounded-lg sm:px-8 md:px-12 sm:py-8 lg:w-5/6 xl:w-2/3">
                <div class="mt-8 prose prose-slate mx-auto lg:prose-lg">
                    ...
                    <ul>
                        ...
                        <li>
                            <x-link link="https://www.offbeatstores.com/products/offbeat-dash-24ghz-wireless-bluetooth-51-mouse-dual-mode-slim-rechargeable-silent-wireless-mouse-3-adjustable-dpi-works-on-2-devices-at-the-same-time-for-windowsmacandroidipadsmart-tv">Offbeat® - DASH - Wireless Mouse</x-link> is the mouse I bought alongwith my keyboard, which does the job, pretty happy with it.
                        <li>
                            <x-link link="http://www.nexstand.com/">Nexstand</x-link> is my preferred laptop stand to gain some height to reduce the strain on my neck.
                        </li>
                    </ul>
                </div>
            </div>
